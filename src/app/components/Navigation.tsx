    ...
    <div className="flex w-full items-center justify-between px-12 py-6">
      ...
      <div className="flex items-center gap-5 text-xl font-medium">
        <button
          ...
          className="fixed bottom-12 right-20 z-40 rounded-full bg-blue-600 animate-bounce border-2 border-black border-solid"
        >
          {session ? (
            <div className="text-5xl p-4 flex text-white">
              <BsChatLeftQuoteFill />
            </div>
          ) : (
            <div className="animate-pulse">Loading</div>
